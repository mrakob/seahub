...
if getattr(settings, 'ENABLE_SYSADMIN_EXTRA', False):
    ...
    urlpatterns += patterns('',
        url(r'^api/v2.1/admin/login/$', Login.as_view(), name='api-v2.1-login'),
        ...
        url(r'^api/v2.1/admin/file-audit/$', FileAudit.as_view(), name='api-v2.1-file-audit'),
        ...
        url(r'^api/v2.1/admin/file-update/$', FileUpdate.as_view(), name='api-v2.1-file-update'),
        ...
        url(r'^api/v2.1/admin/perm-audit/$', PermAudit.as_view(), name='api-v2.1-perm-audit'),
